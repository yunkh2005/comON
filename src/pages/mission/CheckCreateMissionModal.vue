                        ...
                        <div v-if="!enterYn">
                            ...
                            <div class="pt-10 divide-y-2 divide-gray-300">
                                <div class="flex justify-between w-2/3 m-auto pt-7">
                                    <div class="font-bold text-lg w-1/3">미션 이름</div>
                                    <div>미션이름입니다.</div>
                                </div>
                                <div class="flex justify-between w-2/3 m-auto pt-7">
                                    <div class="font-bold text-lg w-1/3">보상</div>
                                    <div>100,000,000 원</div>
                                </div>
                                <div class="flex justify-between w-2/3 m-auto pt-7">
                                    <div class="font-bold text-lg w-1/3">설명</div>
                                    <div>설명입니다.</div>
                                </div>
                                <div class="flex justify-between w-2/3 m-auto pt-7">
                                    <div class="font-bold text-lg w-1/3">기간</div>
                                    <div>2023/03/01 ~ 2023/03/31</div>
                                </div>
                                <div class="flex justify-between w-2/3 m-auto"></div>
                            </div>
                            <!-- 버튼 -->
                            <div class="flex place-content-center p-10 cursor-pointer">
                                ...
                                <button @click="enterYn = true" class="w-1/2 ml-5 p-4 text-center bg-skyblue hover:bg-mainblue hover:text-white text-lg font-semibold rounded-lg">
                                    생성
                                </button>
                            </div>
                        </div>
