<template>
	<div class="">
		<!-- nav -->
		<div class="flex fixed bottom-0 justify-between w-full pl-10 pr-10 pt-3 pb-3 bg-white border-t border-gray-300">
			<div class="hover:bg-gray-200 cursor-pointer">
				<i class="fa-solid fa-list-ul text-2xl place-content-center"></i>
				<div class="justifys-center text-xs font-bold">내역</div>
			</div>
			<div class="hover:bg-gray-200 cursor-pointer">
